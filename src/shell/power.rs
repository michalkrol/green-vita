...
/// Regression guard: with the profile engaged, drift regressed ~8× (≈2 s/min vs
/// the ≈1 s/4 min floor), so the clock/wireless overrides hurt more than they
/// help on this setup. Flip to true only for A/B retests.
